...
static inline bool LocationInDownloadLayer(NSPoint location) {
    return NSPointInTriangle(location, (NSPoint){47,0}, (NSPoint){0,73}, (NSPoint){47,73});
};
...
- (BOOL)mouseEntered:(NSEvent *)theEvent
{
    ...
    if(LocationInDownloadLayer(location))
    {
