...
@interface TVDBImageOperation : AFHTTPRequestOperation
...
- (void)setCompletionBlockWithSuccess:(nullable void (^)(TVDBImageOperation *operation, NSImage *poster))success
                              failure:(nullable void (^)(TVDBImageOperation *operation, NSError *error))failure;
